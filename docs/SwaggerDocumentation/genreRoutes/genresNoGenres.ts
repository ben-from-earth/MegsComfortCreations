const genresNoGenres = {
  get: {
    tags: ['Genres'],
    summary: 'Paginated media collection of items not linked to any genres',
    description:
      'Using limit, page, sort, asc/desc, collect a list of media rows from the database based on the parameters that have no associated genres.',
    parameters: [
      {
        in: 'query',
        name: 'limit',
    ...
    responses: {
      ...
      422: {
        description: 'Missing Genre Pagination Parameters',
        content: {
          'application/json': {
            schema: {
              type: 'object',
            ...
            example: {
              error: 'Missing Genre Pagination Parameters',
              message:
